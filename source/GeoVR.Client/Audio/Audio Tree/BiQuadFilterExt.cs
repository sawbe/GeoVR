...
namespace GeoVR.Client
{
    ...
    public class BiQuadFilterExt
    {
        ...
        /// </summary>
        public static BiQuadFilterExt LowPassFilter(float sampleRate, float cutoffFrequency, float q)
        {
            var filter = new BiQuadFilterExt();
        ...
        /// </summary>
        public static BiQuadFilterExt HighPassFilter(float sampleRate, float cutoffFrequency, float q)
        {
            var filter = new BiQuadFilterExt();
        ...
        /// </summary>
        public static BiQuadFilterExt BandPassFilterConstantSkirtGain(float sampleRate, float centreFrequency, float q)
        {
            ...
            var a1 = -2 * cosw0;
            var a2 = 1 - alpha;
            return new BiQuadFilterExt(a0, a1, a2, b0, b1, b2);
        }

        /// <summary>
        /// Create a bandpass filter with constant peak gain
        /// </summary>
        public static BiQuadFilterExt BandPassFilterConstantPeakGain(float sampleRate, float centreFrequency, float q)
        {
        ...
        /// </summary>
        public static BiQuadFilterExt NotchFilter(float sampleRate, float centreFrequency, float q)
        {
            // H(s) = (s^2 + 1) / (s^2 + s/Q + 1)
            var w0 = 2 * Math.PI * centreFrequency / sampleRate;
            var cosw0 = Math.Cos(w0);
        ...
        /// </summary>
        public static BiQuadFilterExt AllPassFilter(float sampleRate, float centreFrequency, float q)
        {
        ...
        /// Create a Peaking EQ
        /// </summary>
        public static BiQuadFilterExt PeakingEQ(float sampleRate, float centreFrequency, float q, float dbGain)
        {
            var filter = new BiQuadFilterExt();
        ...
        /// <param name="dbGain">Gain in decibels</param>
        public static BiQuadFilterExt LowShelf(float sampleRate, float cutoffFrequency, float shelfSlope, float dbGain)
        {
            var w0 = 2 * Math.PI * cutoffFrequency / sampleRate;
            var cosw0 = Math.Cos(w0);
            var sinw0 = Math.Sin(w0);
        ...
        /// <returns></returns>
        public static BiQuadFilterExt HighShelf(float sampleRate, float cutoffFrequency, float shelfSlope, float dbGain)
        {
            var w0 = 2 * Math.PI * cutoffFrequency / sampleRate;
            var cosw0 = Math.Cos(w0);
            var sinw0 = Math.Sin(w0);
        ...
        public BiQuadFilterExt(double a0, double a1, double a2, double b0, double b1, double b2)
        {
